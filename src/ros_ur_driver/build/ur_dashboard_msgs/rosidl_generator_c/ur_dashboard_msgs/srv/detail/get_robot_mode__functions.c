  ...
  ur_dashboard_msgs__srv__GetRobotMode_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ur_dashboard_msgs__srv__GetRobotMode_Request * data =
      (ur_dashboard_msgs__srv__GetRobotMode_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_dashboard_msgs__srv__GetRobotMode_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ur_dashboard_msgs__srv__GetRobotMode_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  ur_dashboard_msgs__srv__GetRobotMode_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ur_dashboard_msgs__srv__GetRobotMode_Response * data =
      (ur_dashboard_msgs__srv__GetRobotMode_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_dashboard_msgs__srv__GetRobotMode_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ur_dashboard_msgs__srv__GetRobotMode_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
