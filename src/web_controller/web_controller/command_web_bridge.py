...
class CommandWebBridge(Node):
    def __init__(self):
        super().__init__('command_web_bridge')


app = FastAPI()


templates_path = r"/home/kkk/total_care_project/src/robot_base/robot_base/sba_web_controller/templates"
static_path = r"/home/kkk/total_care_project/src/robot_base/robot_base/sba_web_controller/static"
...
def authenticate_user(user_id: str, password: str):
    users_db = {}
    with open(r"/home/kkk/total_care_project/src/robot_base/robot_base/sba_web_controller/lib/user.json", "r") as fp:
...
def main():
    ...
    command_web_bridge = CommandWebBridge()

    try:
        uvicorn.run("robot_base.command_web_bridge:app",
                    host="0.0.0.0",
                    port=5005,
                    log_level="info",
                    reload=True,
    ...
    command_web_bridge.destroy_node()
    rclpy.shutdown()
