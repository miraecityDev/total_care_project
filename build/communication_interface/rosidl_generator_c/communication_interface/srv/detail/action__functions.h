...
#ifndef COMMUNICATION_INTERFACE__SRV__DETAIL__ACTION__FUNCTIONS_H_
#define COMMUNICATION_INTERFACE__SRV__DETAIL__ACTION__FUNCTIONS_H_
 ...
 * calls
 * communication_interface__srv__Action_Request__init().
...
/**
 * It calls
 * communication_interface__srv__Action_Request__fini()
 ...
 * communication_interface__srv__Action_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * communication_interface__srv__Action_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * communication_interface__srv__Action_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_interface
...
/**
 * It calls
 * communication_interface__srv__Action_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_interface
...
/**
 * It allocates the memory for the array and calls
 * communication_interface__srv__Action_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_interface
...
/**
 * It calls
 * communication_interface__srv__Action_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMUNICATION_INTERFACE__SRV__DETAIL__ACTION__FUNCTIONS_H_
