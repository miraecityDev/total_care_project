...
#include "communication_interface/srv/detail/action__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const communication_interface::srv::Action_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<communication_interface::srv::Action_Request *>(
    untyped_ros_message);
...
{
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Action_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const communication_interface::srv::Action_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<communication_interface::srv::Action_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Action_Response__handle;
}
...
{
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Action__handle;
}
