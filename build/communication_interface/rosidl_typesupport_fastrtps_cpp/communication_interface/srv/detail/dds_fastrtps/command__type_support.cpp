...
#include "communication_interface/srv/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const communication_interface::srv::Command_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: cmd_code
  cdr << ros_message.cmd_code;
  // Member: cmd_value
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  communication_interface::srv::Command_Request & ros_message)
{
  // Member: cmd_code
  cdr >> ros_message.cmd_code;
...
{
  auto typed_message =
    static_cast<const communication_interface::srv::Command_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<communication_interface::srv::Command_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_communication_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<communication_interface::srv::Command_Request>()
{
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_interface, srv, Command_Request)() {
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_communication_interface
cdr_serialize(
  const communication_interface::srv::Command_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: message
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  communication_interface::srv::Command_Response & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
...
{
  auto typed_message =
    static_cast<const communication_interface::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<communication_interface::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_interface, srv, Command_Response)() {
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
{
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_interface, srv, Command)() {
  return &communication_interface::srv::typesupport_fastrtps_cpp::_Command__handle;
}
